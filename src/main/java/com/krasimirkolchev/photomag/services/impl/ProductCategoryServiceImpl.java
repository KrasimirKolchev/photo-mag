...
public class ProductCategoryServiceImpl implements ProductCategoryService {
    ...
    private void init() {
        if (this.productCategoryRepository.count() == 0) {
            ...
            ProductCategory batteries = new ProductCategory("Accessories", "https://magazin.photosynthesis.bg/153795-thickbox_default/aksesoar-giottos-cl1001-komplekt-za-pochistvane-ot-5-chasti.jpg");
            ...
            this.productCategoryRepository.saveAll(List.of(dslrCamera, lenses, flashes, bags, batteries, tripods));
        }
    }
